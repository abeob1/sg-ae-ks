...
#End Region
    ...
    Sub Main()
        ...
        Try
            ...
            If ConnectToTargetCompany(p_oCompany, p_oCompDef.sSAPDBName, sErrDesc) <> RTN_SUCCESS Then Throw New ArgumentException(sErrDesc)
            ...
            If IdentifyTXTFile_JournalEntry(sErrDesc) <> RTN_SUCCESS Then Throw New ArgumentException(sErrDesc)
